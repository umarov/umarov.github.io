...
export class RepoGridTile extends LitElement {
  ...
  public render(): TemplateResult {
    return html`
      <div class="mdc-grid-tile__primary">
        ${this.language
          ? html`
              <img class="mdc-grid-tile__primary-content" src="images/${this.language}.png" />
            `
          : html`
              <h3>${this.name}</h3>
            `}
      ...
      <span class="mdc-grid-tile__secondary" data-repo-url="${this.htmlUrl}">
        ...
        <button class="mdc-button mdc-button--dense" style="--mdc-theme-primary: white" data-repo-url="${this.htmlUrl}">
          Repo
        </button>
  ...
  public createRenderRoot(): RepoGridTile {
    return this;
  }
}
